...
from utils import CTCLabelConverter, AttnLabelConverter, Averager, info_nce_loss, accuracy
...
def validation(model, criterion, evaluation_loader, converter, device, opt, topk=(1,2,3,4,5)):
    ...
    for i, (image_tensors, labels) in enumerate(evaluation_loader):
        ...
        # image1 = data_transform(image_tensors)
        # image2  = data_transform(image_tensors)
...
def head_validation(model, head, criterion, evaluation_loader, converter, opt):
    """ validation or evaluation """
    n_correct = 0
    norm_ED = 0
    length_of_data = 0
